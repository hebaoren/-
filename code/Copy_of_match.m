function [solution,cor1,cor2,cor1_2,cor2_2,cor11,cor22,cor11_2,cor22_2]= Copy_of_match(im1, im2,des1,loc1,des2,loc2, ...
                                                          des1_2,loc1_2,des2_2,loc2_2,is_multi_region)
distRatio = 0.94;   % 放宽了阈值
...
num2 = size(cor1,1)+size(cor1_2,1);
fprintf('After FSC found %d matches.\n', num2);
fprintf('CMR is %f.\n',num2/num1);
fprintf('RMSE is %f and %f.\n', rmse, rmse2);
button=appendimages(im2,im1,cor2,cor1,cor2_2,cor1_2);
cor1=cor1(:,1:6);
cor2=cor2(:,1:6);
cor1_2=cor1_2(:,1:6);
cor2_2=cor2_2(:,1:6);
