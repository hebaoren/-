function [hist,max_value]=calculate_oritation_hist_sar(x,y,scale,gradient,angle,n,image_show)
% 180 18个bin
...
hist=zeros(1,n);
hist(1)=(temp_hist(17)+temp_hist(3))/16+...
    4*(temp_hist(18)+temp_hist(2))/16+temp_hist(1)*6/16;
